...
class CardPrintingRepository extends ServiceEntityRepository
{
    ...
    */
    public function findBySet(Set $set, ?string $foiling = '', ?bool $hideOwnedCards = false, ?string $cardName = '', ?bool $collectorView = false): array
    {
        $qb = $this->buildCoreQuery($foiling, $hideOwnedCards, $cardName, $collectorView);
    ...
    * @return CardPrinting[] Returns an array of CardPrinting objects
    */
    public function findByClass(string $className, ?string $foiling = '', ?bool $hideOwnedCards = false, ?string $cardName = ''): array
    {
    ...
    private function buildCoreQuery(?string $foiling = '', ?bool $hideOwnedCards = false, ?string $cardName = '', ?bool $collectorView = false): QueryBuilder
    {
        $qb = $this->createQueryBuilder('cp');
